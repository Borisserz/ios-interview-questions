...
- [How Swift handles memory](#swift-memory-management)
- [Explain ARC](#explain-arc)
- [Identify and resolve a retain cycle](#retain-cycle)
- [Identify and resolve a memory leak](#memory-leak)
- [weak vs unowned](#weak-vs-unowned)
- [Side tables](#side-tables)
- [autoreleasepool](#autoreleasepool)
- [Deep vs shallow copy](#deep-vs-shallow)

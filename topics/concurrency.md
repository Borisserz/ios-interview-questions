...
- [GCD vs async/await](#gcd-vs-async-await)
- [Concurrency problems](#concurrency-problems)
- [Thread explosion](#thread-explosion)
- [DispatchGroup](#dispatch-group)
- [DispatchSemaphore](#dispatch-semaphore)
- [Which thread runs deinit](#deinit-thread)
- [Thread-safe shared state](#thread-safe-state)
- [GCD vs OperationQueue](#gcd-vs-operationqueue)
- [Task vs Task.detached vs TaskGroup](#task-detached-taskgroup)
- [main.async vs main.sync](#main-async-vs-sync)
- [Actor vs serial DispatchQueue](#actor-vs-serial-queue)
- [Task groups vs async let](#taskgroup-vs-async-let)
- [Timeout on an await](#async-timeout)
- [Sendable](#sendable)
- [Task cancellation](#task-cancellation)
- [@MainActor](#main-actor)
- [Checked continuations](#checked-continuation)
- [Locks](#locks)
- [Quality of Service](#qos)
- [DispatchWorkItem](#dispatch-work-item)
- [AsyncSequence](#async-sequence)
- [Actor reentrancy](#actor-reentrancy)
- [Swift 6 strict concurrency](#swift-6-concurrency)
- [Isolation domains](#isolation)
- [Global actors](#global-actor)

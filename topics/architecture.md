...
- [Functional programming in Swift](#functional-programming)
- [KVO](#kvo)
- [Singletons — when they help](#singletons)
- [Global variables](#global-variables)
- [Phantom types](#phantom-types)
- [Design patterns in iOS](#design-patterns)
- [atomic vs nonatomic vs copy](#atomic-nonatomic)
- [Repository pattern](#repository)
- [Feature flags](#feature-flags)
- [Modular architecture](#modular-architecture)
- [Optimistic updates](#optimistic-updates)
- [Kotlin Multiplatform from iOS](#kmp)
